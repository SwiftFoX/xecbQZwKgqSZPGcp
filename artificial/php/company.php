...
<section id="company" class="hdr-sc">
  ...
  <section class="med-lt-grey-sc rg-sc title-sc">
    <div class="container quote">
      <p>Artificial Animation is a <strong>flexible and cutting edge IT service provider</strong>
        based in Zurich. We offer your company <strong>tailored solutions</strong> as well as
        <strong>competent consulting</strong> in many fields. The main focus of Syonix lies on
        <strong>web and individual development</strong> as well as management and processing of
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <img class="img-responsive" src="./images/me.jpg" alt="Dayan Balevski - Graphic Designer &amp; Web Developer">
                  <h4 class="modal-title" id="myModalLabel">Dayan Balevski</h4>
                ...
                <div class="modal-body">
                  <div class="skills">
                    ...
                    <span class="skill">CSS3/LESS</span>
                  ...
                  <div class="bio">
                  <p>Currently studying Computer Science­ with focus on software
                    engineering,­ user interaction­ and information security.­ Over 6 years
                    of experience in web- and­ application development.</p>
                  </div>
                  <div class="timeline">
                  	<div class="row">
                      <div class="timeline-centered">
                          <article class="timeline-entry">
                              <div class="timeline-entry-inner">
                                  <div class="timeline-icon bg-reg">
                          ...
                          <article class="timeline-entry begin">
                              <div class="timeline-entry-inner">
                                  <div class="timeline-icon bg-dark">
                                      <i class="entypo-flight"></i><i  style="margin-top:2px;" class="fa fa-child"></i>
                                  </div>
                              </div>
                          </article>
                      </div>
                ...
                <div class="modal-footer">
                  <button type="button" class="btn generic-btn hvr-rectangle-out" data-dismiss="modal">Close</button>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="modal fade" id="ronald" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                  <h4 class="modal-title" id="myModalLabel">Ronald Griffin</h4>
                	<p>Motion Graphics Designer</p>
                </div>
                <div class="modal-body">
                  <p>Currently studying Computer Science­ with focus on software
          ...
          <div class="modal fade" id="john" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                  <h4 class="modal-title" id="myModalLabel">John Rowley</h4>
                	<p>System Administrator</p>
                </div>
                <div class="modal-body">
                  <p>Currently studying Computer Science­ with focus on software
        ...
        <div class="modal fade" id="marcus" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModalLabel">Marcus Knudsen</h4>
                <p>Audio Technician</p>
              </div>
              <div class="modal-body">
                <p>Currently studying Computer Science­ with focus on software
        ...
        <div class="featured-row clearfix">
          <div class="featured-col">
            <a href="#" target="_blank">
              <img class="logo" src="http://syonix.ch/en/wp-content/themes/syonix/img/clients/restlezz.png"/>
            </a>
          </div>
          <div class="featured-col">
            <a href="#" target="_blank">
...
$(function() {
  ...
  memberCircle.circlemouse({
    onMouseEnter	: function( el ) {
      ...
      el.parent().find('.bio-btn').fadeIn("fast");
    },
    onMouseLeave	: function( el ) {
      if (!inside ){
        el.removeClass('ec-circle-hover hvr-ripple-out');
        el.parent().find('.bio-btn').fadeOut("fast");
      }
    },
    onClick			: function( el ) {
